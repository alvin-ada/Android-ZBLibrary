...
import zblibrary.xscan.adapter.ProofAdapter;
 ...
 */
public class ProofListActivity extends BaseHttpRecyclerActivity<Proof, ProofView, ProofAdapter> implements OnBottomDragListener {
	...
	public static Intent createIntent(Context context, int range) {
		return new Intent(context, ProofListActivity.class).putExtra(INTENT_RANGE, range);
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.proof_list_activity, this);
	...
	@Override
	public void setList(final List<Proof> list) {
		setList(new AdapterCallBack<ProofAdapter>() {

			@Override
			public ProofAdapter createAdapter() {
				return new ProofAdapter(context);
			}

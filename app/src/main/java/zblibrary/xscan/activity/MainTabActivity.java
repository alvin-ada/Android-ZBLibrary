...
import zblibrary.xscan.DEMO.DemoTabFragment;
import zblibrary.xscan.R;
import zblibrary.xscan.fragment.HomeFragment;
import zblibrary.xscan.fragment.MallFragment;
import zblibrary.xscan.fragment.SettingFragment;
import zblibrary.xscan.fragment.UserListFragment;
import zblibrary.xscan.fragment.UserRecyclerFragment;
...
public class MainTabActivity extends BaseBottomTabActivity implements OnBottomDragListener {
    ...
    protected Fragment getFragment(int position) {
        switch (position) {
            ...
            case 1:
                return MallFragment.createInstance();
            case 2:
            default:
...
//			return UserListFragment.createInstance(UserListFragment.RANGE_ALL);
    ...
    private static final String[] TAB_NAMES = {"首页", "商城", "我的"};
